...
if (arguments != 12):
    print("Error: Usage submitgeneratevariablelistexperimentgrouptimeseriesfiles.py experimentgroup experimentgrouphistoryfiletype experimentgrouphistorylist experiment experimentlist variablefilesdir startyear endyear generateexperimentgroupcommand updateexperimentgroupcommand queuename projectcode")
    sys.exit()
...
generateexperimentgroupcommand = str(sys.argv[9])
updateexperimentgroupcommand = str(sys.argv[10])
submitqueuename = str(sys.argv[11])
submitprojectcode = str(sys.argv[12])
...
for variablelistindex in range(numvariables+1):
    ...
    if (variablelistindex == 0):
        ...
        if (gf.variableprocesstypes[variablelistindex-1] == "TimeSeries"):
            processvariable = 1
