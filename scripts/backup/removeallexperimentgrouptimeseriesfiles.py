...
if (arguments != 7):
    print("Error: Usage removeallexperimentgrouptimeseriesfiles.py experimentgroup experimentgrouphistorylist experiment experimentlist startyear endyear removeexperimentgroupcommand")
    sys.exit()
else:
...
removeexperimentgroupcommand = str(sys.argv[7])
...
for experimentgrouphistorylistindex in range(numexperimentgrouphistorys):
    if (experimentgroupname == experimentgrouphistoryshortnames[experimentgrouphistorylistindex]):
        ...
        subprocesscommand = removeexperimentgroupcommand + " " + experimentgroupname + " " + experimentgrouphistoryfiletype + " " + experimentname + " " + requestedstartyearname + " " + requestedendyearname 
