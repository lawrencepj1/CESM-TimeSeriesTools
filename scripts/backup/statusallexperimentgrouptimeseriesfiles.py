...
if (arguments != 5):
    print("Error: Usage removeallexperimentgrouptimeseriesfiles.py experimentgroup experimentgrouphistorylist experiment experimentlist statusexperimentgroupcommand")
    sys.exit()
else:
